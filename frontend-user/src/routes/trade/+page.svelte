<script lang="ts">
  ...
  import { isAuthenticated, wallets, lastPrice } from '$lib/stores/exchange';
  import { api, type Trade, type Wallet } from '$lib/api';
...
<div class="max-w-7xl mx-auto p-4 space-y-4 animate-fade-in">
  <div class="flex items-center gap-3 flex-wrap">
    <h1 class="text-xl font-bold">تداول فوري</h1>
